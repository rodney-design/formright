    ...
    return (
      <div className="max-w-md mx-auto text-center py-24 px-6">
        ...
        <p className="text-gray-500 text-sm mb-6">
          Your account ({user.email}) doesn&apos;t have contractor access.
        </p>
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-navy text-white px-8 py-4 flex items-center justify-between">
        <div className="font-serif font-bold">
          ...
          <span className="text-xs font-sans font-normal text-white/50 ml-2">Contractor</span>
        </div>
        <div className="flex items-center gap-4 text-sm">
          <span className="text-white/60">{user.email}</span>
          <Link href="/contractor" className="text-white/60 hover:text-white">
            My Jobs
          </Link>
